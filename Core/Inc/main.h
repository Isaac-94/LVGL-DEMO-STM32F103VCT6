...
#define TS_IRQ_Pin GPIO_PIN_10
#define TS_IRQ_GPIO_Port GPIOD
#define TS_MISO_Pin GPIO_PIN_11
#define TS_MISO_GPIO_Port GPIOD
#define TS_MOSI_Pin GPIO_PIN_13
#define TS_MOSI_GPIO_Port GPIOD
#define TS_CS_Pin GPIO_PIN_14
#define TS_CS_GPIO_Port GPIOD
#define TS_SCK_Pin GPIO_PIN_15
#define TS_SCK_GPIO_Port GPIOD
